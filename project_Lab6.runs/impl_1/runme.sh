...
HD_PWD='/home/it/project_Lab6/project_Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplication.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplication.tcl -notrace
