...
HD_PWD='/home/it/project_Lab6/project_Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplication.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplication.tcl
